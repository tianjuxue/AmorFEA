...
class TrainerNonlinear(Trainer):
    ...
    def run(self):
        ...
        self.data_X = np.load(self.args.root_path + '/' + self.args.numpy_path + '/' + self.graph.name +
        ...
        for epoch in range(self.args.epochs):
            ...
            if L_inf < 1e-4:
                break
        torch.save(self.model, self.args.root_path + '/' + self.args.model_path + '/model')

    def debug(self):
        model_path = self.args.root_path + '/' + self.args.model_path + '/model'
