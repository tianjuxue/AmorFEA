...
def add_args(parser):
    rt_path = 'data'
    sub_paths = ['images', 'solutions', 'numpy', 'models', 'others']
    ...
    parser.add_argument('--model_path', type=str, default=sub_paths[3])    
    parser.add_argument('--others_path', type=str, default=sub_paths[4])
